 ...
 * "Список Полученых Ресурсов" (table Resources and Acc_Resources)
 * "Список Полученых Апгрейдов" (table Upgrades and Acc_Upgrades)
 * "Список Построеных Зданий Противника" (table Building and Acc_Building)
 * "Список Полученых Ресурсов Противника" (table Resources and Acc_Resources)
 * "Список полученых Апгрейдов Противника" (table Upgrades and Acc_Upgrades)
